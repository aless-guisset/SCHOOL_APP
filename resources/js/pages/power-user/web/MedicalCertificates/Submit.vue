...
const breadcrumbs = computed(() => [
    ...
    { label: t('medical_certificate.breadcrumb_submit') },
]);
</script>

<template>
    <Head :title="t('medical_certificate.submit_title')" />
    <AppLayout>
        <div class="p-4 md:p-6 max-w-lg">
            <FlashMessage />
            <PageHeader :title="t('medical_certificate.submit_title')" :breadcrumbs="breadcrumbs" />
            <Card>
                <CardContent class="pt-6">
                    <form class="space-y-4" @submit.prevent="submit">
                        ...
                        <div class="space-y-1.5">
                            <Label for="attachment">{{ t('medical_certificate.field_attachment') }} *</Label>
                        ...
                        <Button type="submit" :disabled="form.processing">{{ t('action.submit') }}</Button>
                    </form>
                </CardContent>
            </Card>
        </div>
