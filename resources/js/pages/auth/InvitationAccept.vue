...
// Le contrôleur ne transmet pas le token en prop : il est déjà présent dans
// l'URL courante (`/invitations/{token}/accept`), donc on le récupère
// directement depuis l'URL plutôt que de dupliquer l'information.
    ...
    >
        ...
        <form class="flex flex-col gap-6" @submit.prevent="submit">
            ...
            <p v-else class="text-sm text-muted-foreground">
                Un compte existe déjà pour cette adresse. Cliquez ci-dessous pour rejoindre {{ props.school_name }}.
            </p>

            <Button type="submit" class="w-full" :disabled="processing" data-test="invitation-accept-button">
