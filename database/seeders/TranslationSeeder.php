...
class TranslationSeeder extends Seeder
{
    public function run(): void
    {
        $translations = [
            ...
            'mon_cours.due_date' => ['fr' => 'Échéance',                            'en' => 'Due date', 'nl' => 'Vervaldatum', 'es' => 'Fecha límite'],
            'mon_cours.confirm_delete_devoir' => ['fr' => 'Supprimer ce devoir ?',                'en' => 'Delete this homework?', 'nl' => 'Dit huiswerk verwijderen?', 'es' => '¿Eliminar este deber?'],
            'mon_cours.resources' => ['fr' => 'Ressources',                          'en' => 'Resources', 'nl' => 'Bronnen', 'es' => 'Recursos'],
            'mon_cours.add_resource' => ['fr' => 'Ajouter une ressource',                'en' => 'Add a resource', 'nl' => 'Bron toevoegen', 'es' => 'Añadir un recurso'],
            'mon_cours.no_resources' => ['fr' => 'Aucune ressource pour ce cours.',      'en' => 'No resources for this course.', 'nl' => 'Geen bronnen voor dit vak.', 'es' => 'No hay recursos para este curso.'],
            'mon_cours.resource_type' => ['fr' => 'Type',                                'en' => 'Type', 'nl' => 'Type', 'es' => 'Tipo'],
            'mon_cours.resource_type_link' => ['fr' => 'Lien externe',                        'en' => 'External link', 'nl' => 'Externe link', 'es' => 'Enlace externo'],
            'mon_cours.resource_type_file' => ['fr' => 'Fichier',                             'en' => 'File', 'nl' => 'Bestand', 'es' => 'Archivo'],
            'mon_cours.resource_file_hint' => ['fr' => 'Fichier (PDF, Word, PowerPoint, Excel ou image, 10 Mo max)', 'en' => 'File (PDF, Word, PowerPoint, Excel or image, 10 MB max)', 'nl' => 'Bestand (PDF, Word, PowerPoint, Excel of afbeelding, max. 10 MB)', 'es' => 'Archivo (PDF, Word, PowerPoint, Excel o imagen, máx. 10 MB)'],
            'mon_cours.resource_url' => ['fr' => 'URL',                                 'en' => 'URL', 'nl' => 'URL', 'es' => 'URL'],
            'mon_cours.confirm_delete_resource' => ['fr' => 'Supprimer cette ressource ?',          'en' => 'Delete this resource?', 'nl' => 'Deze bron verwijderen?', 'es' => '¿Eliminar este recurso?'],
            'mon_cours.session_history' => ['fr' => 'Historique des séances',               'en' => 'Session history', 'nl' => 'Geschiedenis van de lessen', 'es' => 'Historial de sesiones'],
            'mon_cours.no_sessions' => ['fr' => 'Aucune séance enregistrée pour ce cours.', 'en' => 'No recorded sessions for this course.', 'nl' => 'Geen geregistreerde lessen voor dit vak.', 'es' => 'No hay sesiones registradas para este curso.'],
            'mon_cours.attendance_submitted' => ['fr' => 'Présences soumises',                   'en' => 'Attendance submitted', 'nl' => 'Aanwezigheid ingediend', 'es' => 'Asistencia enviada'],
